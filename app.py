...
global lasttime = get_recent_game_no()
    
global starttime = lasttime-10

global pre_resultstr = ""
global crawlNo=[]
global cpucnt = cpu_count()
global multipool = Parallel(n_jobs=(cpucnt*4))
global poolfn = delayed(get_lotto)
